...
class RenderService {
    ...
    #replaceComponentTags(parentElement, components)// Если есть тэги компонентов, то рендерю их
    {
        ...
        for( const element of allElements )
        {
            ...
            if( componentTagPattern.test(element.tagName) )
            {
    ...
    #applyModuleStyles(moduleStyles, element)// Добавляю стили и заменяю названия классов
    {
        if( !element ){ return }
